...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Pegando o Evento de Click do Button
        ...
        //Trata o Listener do botão Abrir Camera
        ...
        when (requestCode) {
            PERMISSION_CODE_IMAGE_PICK -> {
                if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "PEGAR IMAGEM: PERMISSÃO NEGADA", Toast.LENGTH_SHORT).show()
                }
            }
            ...
            PERMISSION_CODE_CAMERA_CAPTURE -> {
                if (grantResults.size > 1 &&
                    ...
                    Toast.makeText(this, "ABRIR CAMERA: PERMISSÃO NEGADA", Toast.LENGTH_SHORT).show()
                }
            }
    ...
    private fun openCamera(){
        val values = ContentValues()
            values.put(MediaStore.Images.Media.TITLE, "new foto")
